...
import ProcureAI from "./ProcureAI";
...
const LandingPage = () => {
  ...
  // If logged in, show the main ProcureAI application
  if (isLoggedIn) {
    return <ProcureAI />;
  }

  // Show the landing page with login form
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
      {/* Header */}
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-white mb-4">ProcureAI</h1>
        <p className="text-xl text-slate-300">Automate Intelligently. Procure Strategically.</p>
      </div>
